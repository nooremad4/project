...
class _SearchPageState extends State<SearchPage> {
  ...
  List<Map<String, dynamic>> get _filteredSellers => _sellers
    ...
    return GestureDetector(
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => ChefPage(
              ...
              topDishes: [
                {'name': 'Kibbeh', 'price': 1.50, 'image': 'assets/images/kibbeh.png'},
                {'name': 'Fattoush', 'price': 2.0, 'image': 'assets/images/fattoush.png'},
                {'name': 'Lemon Cake', 'price': 5.0, 'image': 'assets/images/lemon_cake.png'},
              ],
            ),
          ),
        );
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: const Color.fromARGB(60, 61, 24, 5), width: 0.8),
        ),
        child: Row(
          children: [
            CircleAvatar(
